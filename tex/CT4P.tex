...
\begin{exer}
  Does the category $\bullet$ (the terminal categroy defined in \cref{exa:graph_terminalcat}) have an initial object?
\end{exer}
...
\begin{exer}\label{exer:coproduct_with_terminal} Let $\CC$ be a category and $I\in\Ob{\CC}$ an initial object.
