...
When a category is considered as a model for a programming language, natural transformations model parametric polymorphism.

\section{Definition and First Examples}

Polymorphic functions are functions 
