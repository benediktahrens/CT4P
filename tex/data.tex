...
\begin{intu} An algebra is loosely speaking a set with some \textit{algebraic} operations like multiplication. A simple example is that of a monoid. Example \cref{example:algebra_of_monoids} shows that (the data of) monoids correspond precisely with algebras over a fixed endofunctor.
\end{intu}
