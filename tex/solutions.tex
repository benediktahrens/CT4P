...
\begin{solution}[to \cref{exer:post_antisymmetry}] 
...
\begin{solution}[to \cref{exer:POS_isnt_a_posetcat}]
...
\begin{solution}[ to \cref{exer:categories_coming_from_monoids}] 
...
\begin{solution}[to \cref{exer:category_of_monoids}]
...
\begin{itemize}
\item Composition preserves multiplication by:
\begin{eqnarray*}
\forall x,y\in M_1 : \co{f}{g}(m_1(x,y)) &=& g\left(f(m_1(x,y))\right)\\ 
	&=& g\left(m_2(f(x),f(y)))\right) \quad \text{ since $f$ preserves multiplication} \\
	&=& m_3(g(f(x)),g(f(y))) \quad \text{ since $g$ preserves multiplication}\\
...
\begin{solution}[to \cref{exer:category_with_naturalnumbers_and_matrices}]
...
\begin{solution}[to \cref{exer:opposite}]
...
\begin{solution}[to \cref{exer:connection_graphs_preordersets}]
...
\begin{solution}[to \cref{exer:inverse-iso}]
...
\begin{solution}[to \cref{exer:inverse_uniqueness}]
...
\begin{solution}[to \cref{exer:compofiso}]
...
\begin{solution}[to \cref{exer:iso-bool}]
...
\begin{solution}[to \cref{exer:iso_in_sets}]
...
\begin{solution}[to \cref{exer:iso_in_pos}]
...
\begin{solution}[to \cref{exer:iso_in_posetcategory}]
...
\begin{solution}[to \cref{ex:mono-inj}]
...
\begin{solution}[to \cref{exer:sections_in_set_injective}]
...
\begin{solution}[to \cref{exer:iso_to_monoepi}] 
...
\begin{solution}[to \cref{exer:counterexample_monoepi_not_iso}]
...
\begin{solution}[to \cref{exer:initial_set}] 
...
\begin{solution}[to \cref{exer:initial_posetcat}]
...
\begin{solution}[to \cref{exer:initial-unique}]
...
\begin{solution}[to \cref{exer:initiality_preserved_by_iso}]
...
\begin{solution}[to \cref{exer:cat-without-initial}]
