...
For each set $X\in\Ob \SET$, we define:
\[
\eta_X : X \to (100 X) : x\mapsto (\lambda ?, x).
\]
...
\[
\eta_X^{*}(g)(r) = \eta_X(g(r))(r) = (\lambda ?, g(r))(r) = g(r).
\]
...
\[
f^{*}(\eta_X(x))(r) = f^{*}(\lambda ?,x)(r) = \left(\lambda r', f((\lambda ?, x)(r'))(r')\right)(r) = f((\lambda ?,x)(r))(r) = f(x)(r).
\]
