...
Hence, $g$ acts on singleton lists as $g'$ which uniquely determines a function from $\List(A)$ to $M$.
Indeed, by case analysis (recursion), we can define $g'(\nil)$ as the unit element in $M$ and $g'([a::l])$ as $[g(a) :: g'(l)]$.
Observe that $g'$ is indeed a monoid homomorphism.
